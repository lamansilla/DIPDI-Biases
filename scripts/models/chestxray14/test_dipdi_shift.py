...
if __name__ == "__main__":
    ...
    checkpoint_dir = Path(f"./models/chestxray14/groups/")
    output_dir = Path(f"./models/chestxray14/dipdi_shift/{args.shift}/")
    ...
    for _, younger_prop in enumerate(younger_proportions):
